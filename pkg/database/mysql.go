...
// CreateUser implements IDataBaseUser creates a new user
func (db *Mysql) CreateUser(user *xUserV1.OpenHydraUser) error {
	inst, err := db.getDB()
	if err != nil {
		return err
	}
...
func (db *Mysql) GetUser(name string) (*xUserV1.OpenHydraUser, error) {
	inst, err := db.getDB()
	if err != nil {
		return nil, err
	}
...
func (db *Mysql) UpdateUser(user *xUserV1.OpenHydraUser) error {
	inst, err := db.getDB()
	if err != nil {
		return err
	}
...
func (db *Mysql) DeleteUser(name string) error {
	inst, err := db.getDB()
	if err != nil {
		return err
	}
...
func (db *Mysql) ListUsers() (xUserV1.OpenHydraUserList, error) {
	inst, err := db.getDB()
	if err != nil {
...
func (db *Mysql) LoginUser(name, password string) (*xUserV1.OpenHydraUser, error) {
	inst, err := db.getDB()
	if err != nil {
		return nil, err
	}
