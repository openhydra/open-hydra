...
type IOpenHydraK8sHelper interface {
	...
	CreateDeployment(cpuMemorySet CpuMemorySet, image, namespace, studentID, sandboxName string, volumeMounts []apis.VolumeMount, gpuSet apis.GpuSet, client *kubernetes.Clientset, command, args []string, ports map[string]int, volumes []apis.Volume) error
